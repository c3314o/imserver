...
public class Friendship extends BaseAction {
    ...
    private static Map<String, Integer> mapFilterUserIds = new HashMap<String, Integer>();// 要过滤的用户id
...
//            }
//            mapFilterUserIds.put(serviceUser.getId(), 1);
...
//        }
    ...
    public DataBuffer getUserRecentContact(int userId, DataBuffer attachment,
        ...
        try {
            ...
            if (serviceUser != null) {
                mapFilterUserIds.put(serviceUser.getId(), 1);
                tmpBuffer.writeString(serviceUser.getId());
